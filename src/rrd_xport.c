    ...
    rrd_value_t **data )
{
    ...
    struct optparse_long longopts[] =
    {
        ...
        {"csv",    264, OPTPARSE_NONE},     /* comma-separated values */
        {"tsv",    265, OPTPARSE_NONE},     /* tab-separated values */
        {"ssv",    266, OPTPARSE_NONE},     /* semicolon-separated values */
    ...
    while ( ( opt = optparse_long( &options, longopts, NULL ) ) != -1 )
    {
        ...
        case 263:
            json = 1;
            break;
        case 264:   /* comma-separated */
            break;
        case 265:   /* tab-separated */
            break;
        case 266:   /* semicolon-separated */
            break;
        case 's':
